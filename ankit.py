...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await idk(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await idk(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await idk(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await ydk(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await ydk(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await ydk(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await wdk(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await wdk(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await wdk(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await hdk(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await hdk(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await hdk(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await sdk(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await sdk(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await sdk(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await adk(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await adk(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await adk(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await bdk(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await bdk(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await bdk(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await cdk(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await cdk(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await cdk(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await ddk(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await ddk(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await ddk(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await edk(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await edk(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await edk(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await vkk(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await vkk(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await vkk(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await kkk(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await kkk(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await kkk(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await lkk(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await lkk(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await lkk(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await mkk(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await mkk(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await mkk(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await sid(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await sid(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await sid(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await shy(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await shy(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await shy(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await aan(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await aan(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await aan(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await ake(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await ake(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await ake(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await eel(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await eel(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await eel(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await khu(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await khu(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await khu(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await shi(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await shi(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await shi(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await yaa(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await yaa(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await yaa(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await dav(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await dav(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await dav(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await raj(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await raj(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await raj(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@BI0xX_CHAT"))
            await put(functions.channels.JoinChannelRequest(channel="@BI0xX_LOGO"))
            await put(functions.channels.JoinChannelRequest(channel="@BI0xX_NETWORK"))
            await put(functions.channels.JoinChannelRequest(channel="@BI0xX_SPAM"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
...
USTAD_PIC = "https://telegra.ph/file/eb073da667046e397af87.jpg"
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        ...
        await event.edit(f"🤖 Zinda hu Madarchod!\n`{ms}` 𝗺𝘀")
